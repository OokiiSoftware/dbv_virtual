...
class SgcClassesPage extends StatefulWidget {
  const SgcClassesPage({super.key});

  @override
  State<StatefulWidget> createState() => _State();
}
class _State extends State<SgcClassesPage> {
  ...
  Widget build(BuildContext context) {
    ...
    // bool solicitacaoclasses = context.watch<EditEspecialidadesProvider>().list.isNotEmpty;

    double appBarHeigth = 120;
    // if (solicitacaoclasses) {
    //   appBarHeigth += 80;
    // }
                    ...
                    children: [
                      Container(
                        ...
                        child: ElevatedButton.icon(
                          ...
                          label: const Text('Atribuir Classes'),
                      ...
                      //       title: const Text('Solicitação de classes'),
                      //       subtitle: const Text('Alguns membros solicitaram a adição de suas classes'),
                      //     ),
                      //   ),
                    ],
                  ),
  ...
  void onItemTap(Membro membro) {
    ...
    Navigate.push(context, SgcClasseMembroPage(
      membro: membro.copy(),
    ));
  }

  void _onAddEspecialidadesTap() async {
    Navigate.push(context, const SgcAddClassePage());
  }

  void _onSolicitacoesTap() async {
    Navigate.push(context, const SgcSolicitacaoClassesPage());
  }
