...
class SgcSolicitacaoClassesPage extends StatefulWidget{
  const SgcSolicitacaoClassesPage({super.key});

  @override
  State<StatefulWidget> createState() => _State();
}
class _State extends State<SgcSolicitacaoClassesPage> {
  ...
  void _onMembroTap(Membro value, EspecialidadeSolicitacao esp) async {
    await Navigate.push(context, SgcSolicitacaoClassesMembroPage(
      membro: value,
      especialidade: esp,
    ));
    setState(() {});
...
class SgcSolicitacaoClassesMembroPage extends StatefulWidget{
  final Membro membro;
  final EspecialidadeSolicitacao especialidade;
  const SgcSolicitacaoClassesMembroPage({
    super.key,
...
class _StateMembro extends State<SgcSolicitacaoClassesMembroPage> {
